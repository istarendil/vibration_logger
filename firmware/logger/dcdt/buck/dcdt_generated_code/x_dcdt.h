 ...
 **/
#ifndef _X_DCDT_DEFINES_H
#define _X_DCDT_DEFINES_H
...
#define X_COMP_3P3Z_COEFF_A1      0x376A
#define X_COMP_3P3Z_COEFF_A2      0xF803
#define X_COMP_3P3Z_COEFF_A3      0xFB08
#define X_COMP_3P3Z_COEFF_B0      0x7FFC
#define X_COMP_3P3Z_COEFF_B1      0x8CF5
#define X_COMP_3P3Z_COEFF_B2      0x8056
#define X_COMP_3P3Z_COEFF_B3      0x735D
#define X_COMP_3P3Z_POSTSCALER    0x607B
#define X_COMP_3P3Z_POSTSHIFT     0xFFFE
#define X_COMP_3P3Z_PRESHIFT      0x0000


// Compensator Clamp Limits
#define X_COMP_3P3Z_MIN_CLAMP    0x0000
#define X_COMP_3P3Z_MAX_CLAMP    0x7FFF
